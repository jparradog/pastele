    ...
    if (isset($_GET['fechai']) && isset($_GET['fechaf'])) {
        ...
        <table style="margin: 15px 0px 0px 15px; width: 98%;" class="table table-bordered">
            ...
            <tbody style="background-color: #ffffff;">    
                ...
                <?php } else if ($fila['fecha'] == "0000-00-00") { ?>
                    <tr class="info">
                        <td colspan="8"><strong>Reinicio de facturacion</strong></td>

                    </tr>
                <?php } else if ($fila['fecha'] == "1111-11-11") { ?>
                    <tr class="warning">
                        <td colspan="8"><strong>Salto de numeración</strong></td>
...
//----------------------------------------------------------------------------//
        ...
        <table style="margin: 15px 0px 0px 15px; width: 98%;" class="table table-bordered">
            ...
            <?php } else if ($fila['fecha'] == "0000-00-00") { ?>
                        <tr class="info">
                            <td colspan="8"><strong>Reinicio de facturación</strong></td>
