...
<html>
    ...
    <body>
        ...
        $sql_clientes = "
            SELECT DISTINCT facturasimple.idcliente , cliente.nombre , cliente.apellido , cliente.2apellido
FROM facturasimple
INNER JOIN cliente
ON cliente.idcliente = facturasimple.idcliente";

        $result_clientes = mysql_query($sql_clientes);
        ?>
        <div class="label label-info" >
            <h3 style="margin-left: 15px;"> Reporte Total de Venta de Facturas Simples por Cliente </h3>
        </div>
                ...
                <tbody>
                    ...
                    while ($fila = mysql_fetch_array($result_clientes)) {
                        ...
                        <tr >
                            ...
                            $sql_ventas = "SELECT total, totaliva FROM facturasimple WHERE fecha BETWEEN $fechai AND $fechaf AND idcliente = $idcliente AND anulada = 0";
