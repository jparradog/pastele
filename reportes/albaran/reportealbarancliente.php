...
<html>
    ...
    <body>
        ...
        $sql_clientes = "
            SELECT DISTINCT albaran.idcliente , cliente.nombre , cliente.apellido , cliente.2apellido
            FROM albaran
            INNER JOIN cliente
            ON cliente.idcliente = albaran.idcliente";

        $result_clientes = mysql_query($sql_clientes);
        ?>
        <div class="label label-info" >
        <h3 style="margin-left: 15px;"> Reporte Total de Venta de Albaranes por Cliente </h3>
        </div>
                ...
                <tbody>
                    ...
                    while ($fila = mysql_fetch_array($result_clientes)) {
                        ...
                        <tr >
                            ...
                            $sql_ventas = "SELECT total FROM albaran WHERE fecha BETWEEN $fechai AND $fechaf AND idcliente = $idcliente AND anulada = 0";
