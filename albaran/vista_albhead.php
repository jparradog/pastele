<div class="well">
<form style="margin-left: 15px;" name="facthead" id="facthead" action="<?php echo validarSesion(); ?>?iu=vista_albreng.php&mdir=albaran" method="post">
  <legend>Nuevo Albaran</legend>
